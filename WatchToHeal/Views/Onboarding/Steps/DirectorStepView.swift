    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            VStack(spacing: 0) {
                // Header
                VStack(spacing: 8) {
                    Text("WHICH DIRECTORS DO YOU ADMIRE?")
                        .font(.system(size: 14, weight: .black))
                        .kerning(2)
                        .foregroundColor(.appPrimary)
                    
                    Text("This is entirely optional. We'll use your picks to personalize future recommendations.")
                ...
                HStack(spacing: 12) {
                    ...
                    TextField("Search your favorite directors...", text: $viewModel.actorSearchQuery)
                        ...
                        if viewModel.actorSearchQuery.isEmpty {
                            ...
                            LazyVGrid(columns: columns, spacing: 24) {
                                ForEach(viewModel.searchedPeople) { person in
                                    let isSelected = viewModel.selectedDirectorIds.contains(person.id)
            ...
            VStack {
                ...
                Button(action: { 
                    ...
                    let hasSelection = !viewModel.selectedDirectorIds.isEmpty
